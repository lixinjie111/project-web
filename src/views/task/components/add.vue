<template>
  <Modal :isShow="isShow" title="创建任务" okText="确定" cancelText="取消" headeralgin="center" @modal-sure="handleSubmit" @modal-cancel="handleCancel">
      ...
      <a-row :gutter="24">
        <a-col :span="12">
          <a-form-model-item label="开始日期" prop="begin_date">
            <a-date-picker placeholder="请选择开始日期" allowClear />
          </a-form-model-item>
        </a-col>
        <a-col :span="12">
          <a-form-model-item label="截止日期" prop="end_date">
            <a-date-picker placeholder="请选择截止日期" allowClear />
          </a-form-model-item>
        </a-col>
      </a-row>
